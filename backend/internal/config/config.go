...
type Config struct {
	...
	SiteURL                 string
	SiteIconURL             string
	PromptTemplateSourceURL string
...
func Load() Config {
	...
	cfg := Config{
		...
		PromptTemplateSourceURL: getenv("PROMPT_TEMPLATE_SOURCE_URL", "https://raw.githubusercontent.com/YouMind-OpenLab/awesome-gpt-image-2/main/README_zh.md"),
