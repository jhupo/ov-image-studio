...
WORKER_COUNT = int(os.environ.get("IMAGE_STUDIO_WORKER_COUNT", "2"))
...
MAX_CONCURRENT_GLOBAL = int(os.environ.get("IMAGE_STUDIO_MAX_CONCURRENT", "4"))
MAX_CONCURRENT_PER_USER = int(os.environ.get("IMAGE_STUDIO_MAX_CONCURRENT_PER_USER", "2"))
MAX_CONCURRENT_PER_KEY = int(os.environ.get("IMAGE_STUDIO_MAX_CONCURRENT_PER_KEY", "2"))
MAX_CONCURRENT_PER_PROFILE = int(os.environ.get("IMAGE_STUDIO_MAX_CONCURRENT_PER_PROFILE", "2"))
